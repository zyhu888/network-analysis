...
## Calculate the efficiency for interested institution subsets
```{r echo=FALSE}
for (institution in institutions_of_interest) {
...
## Calculate the efficiency for interested specialty subsets
```{r echo=FALSE}
for (specialty in specialties_of_interest) {
...
cat("Global clustering coefficient:", global_clustering_coefficient, "\n")
```

## Calculate the global clustering coefficient for interested institution subsets
```{r echo=FALSE}
for (institution in institutions_of_interest) {
  calculate_transitivity_for_institution(institution)
}
```

## Calculate the global clustering coefficient for interested specialty subsets
```{r echo=FALSE}
for (specialty in specialties_of_interest) {
  calculate_transitivity_for_specialty(specialty)
}
```